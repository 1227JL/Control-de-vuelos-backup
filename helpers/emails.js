...
export const emailRegistro = async (datos) => {
    ...
    const info = await transport.sendMail({
        ...
        <a href="${process.env.FRONTEND_URL}/dorado/confirmar/${token}">Comprobar Cuenta</a>
...
export const emailOlvidePassword = async (datos) => {
    ...
    const info = await transport.sendMail({
        ...
        <a href="${process.env.FRONTEND_URL}/dorado/olvide-password/${token}">Restablecer Password</a>
